...
class _LostItemViewScreenState extends State<LostItemViewScreen> {
  ...
  String _itemName = 'Lost Keys';
  String _description = 'Set of car keys with a blue keychain. Lost near the main entrance.';
  String _dateLost = '2023-10-20';
  String _lostLocation = 'Main Entrance';
  String _category = 'Keys';
  String? _imageUrl = 'https://via.placeholder.com/700x700/DC3545/FFFFFF?text=Lost+Keys'; // Placeholder image
  String _status = 'not_found'; // 'not_found', 'found', 'pending_approval', 'rejected'
  bool _isOwner = true; // Simulate if current user is the owner
  String? _reporterTelegram = '@reporter_user'; // Simulate reporter's telegram
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          if (_isOwner && _status != 'found' && _status != 'rejected')
            Align(
          ...
          Column(
            ...
            children: [
              ...
              _buildDetailRow('Date Lost:', _dateLost),
              _buildDetailRow('Lost Location:', _lostLocation),
              const SizedBox(height: 20),
              Container(
  ...
  Widget _buildActionButtons() {
    return Wrap(
      ...
      children: [
        if (_isOwner && _status == 'not_found')
          ElevatedButton.icon(
            onPressed: () {
              _showConfirmationDialog('found');
            },
  ...
  void _showConfirmationDialog(String action) {
    String message = '';
    if (action == 'found') {
      message = "Are you sure you want to mark this lost item as 'Found'? This action cannot be undone.";
    }
