...
class ReportFoundFormScreen extends StatefulWidget {
  ...
  const ReportFoundFormScreen({super.key, this.itemId});
...
class _ReportFoundFormScreenState extends State<ReportFoundFormScreen> {
  ...
  final TextEditingController _dateFoundController = TextEditingController(); // Changed
  ...
  void initState() {
    ...
    if (widget.itemId != null) {
      ...
      _itemNameController.text = 'Found Phone';
      _descriptionController.text = 'A black smartphone found near the main gate.';
      _dateFoundController.text = '2023-10-25'; // Changed
      _locationController.text = 'Main Gate';
      _selectedCategory = 'Electronics';
      _imagePreviewUrl = 'https://via.placeholder.com/150/007bff/FFFFFF?text=Phone'; // Placeholder
    }
  }
  ...
  void dispose() {
    ...
    _dateFoundController.dispose(); // Changed
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        _dateFoundController.text = "${picked.year}-${picked.month.toString().padLeft(2, '0')}-${picked.day.toString().padLeft(2, '0')}"; // Changed
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    final String pageTitle = widget.itemId == null ? 'Report Found Item' : 'Edit Found Item'; // Changed
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: AbsorbPointer(
                              child: TextField(
                                controller: _dateFoundController, // Changed
                ...
                const SizedBox(height: 15),
                _buildTextField(_locationController, 'Location Found', required: true), // Changed
                const SizedBox(height: 20),
                Align(
